...
public class lapor_datacuti extends javax.swing.JFrame {
    private Connection conn=new koneksi().GetConnection();
    private DefaultTableModel tableModel;
    
    public lapor_datacuti() {
        initComponents();
        datatable();
    }
...
protected void datatable(){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            String namaFile = "src/laporan/lap_cuti.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lapor_datacuti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
